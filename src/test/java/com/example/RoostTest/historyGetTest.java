    ...
    public void history_get_Test() {  
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("src/test/java/com/example/RoostTest/historyGetTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
              ...
              if (response.jsonPath().get("cameraNo") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("cameraNo"), instanceOf(Integer.class));  
          }
    
              if (response.jsonPath().get("cameraId") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("cameraId"), instanceOf(String.class));  
          }
    
              if (response.jsonPath().get("feature") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("feature"), instanceOf(String.class));  
          }
    
              if (response.jsonPath().get("coordinates") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("coordinates"), instanceOf(String.class));  
          }
				}
