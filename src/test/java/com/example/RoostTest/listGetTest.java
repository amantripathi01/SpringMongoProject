...
// Test generated for /device/camera/list_get for http method type GET in rest-assured framework
...
public class listGetTest {
    ...
    public void list_get_Test() {  
        ...
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src/test/java/com/example/RoostTest/listGetTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
              ...
              if (response.jsonPath().get("no") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("no"), instanceOf(Integer.class));  
          }
